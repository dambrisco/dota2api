...
pub fn resolve_vanity_url(api_key: String, vanity_url: String) -> u64 {
    return get(TypedUrl::ResolveVanityUrl.value(), &[("key".to_owned(), api_key), ("vanityurl".to_owned(), vanity_url)]);
}
